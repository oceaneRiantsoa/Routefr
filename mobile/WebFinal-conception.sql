...
-- ============================
-- DONNÉES D'EXEMPLE (ANTANANARIVO)
-- ============================
...
-- ============================
-- VUE : RÉCAPITULATION GLOBALE (UNE SEULE LIGNE)
-- ============================
...
SELECT
    ...
    CASE
        WHEN MIN(st.idStatut) = 20 THEN 20       -- tous traités
        WHEN MAX(st.idStatut) >= 10 THEN 10      -- au moins un visé
        ELSE 1                                   -- tous créés
    END AS avancement,
